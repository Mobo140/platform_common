...
//go:generate minimock -i github.com/Mobo140/platform_common/pkg/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/Mobo140/platform_common/pkg/db"
